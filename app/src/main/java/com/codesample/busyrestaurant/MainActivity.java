...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler=new Handler(msg ->{
            ...
            switch(msg.what){
                default:
                case ORDER: list=orders; view=binding.textViewOrderList;break;
                case COOK: binding.textViewCooking.setText("");
                    list=foods; view=binding.textViewFoodList;break;
                case PACK: binding.textViewPacking.setText("");
                    list=packs; view=binding.textViewPackList;break;
                case COOKING: String str="요리중\n"+msg.obj;
                    binding.textViewCooking.setText(str);break;
                case PACKING: str="포장중\n"+msg.obj;
                    binding.textViewPacking.setText(str); break;
            }
